# NOTE: original source comes from alfresco-view-repo/test-data/javawebscripts
#
            ...
            if output:
                ...
                if j and 'elements' in j and j['elements']:
                    ...
                    for projectid in projectIds:
                        ...
                        curl_cmd = create_curl_cmd(type="GET",data="elements/%s?recurse=true&qualified=false"%projectid,
