...
magicdraw_teamwork_iptables:
  file.accumulated:
    ...
    - text: |
        ...
        -A MBEE-INPUT-LOCAL-ACCEPT -p tcp -m state --state NEW -m tcp --dport 17021:17024 -j ACCEPT
        -A MBEE-INPUT-LOCAL-ACCEPT -p tcp -m state --state NEW -m tcp --dport 17051:17054 -j ACCEPT
    - require_in:
        - file: salt_iptables
